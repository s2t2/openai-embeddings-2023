...
if __name__ == "__main__":
    ...
    sql = f'''
        ...
        FROM user_sample u
        LEFT JOIN  `tweet-research-shared.election_2020_transition_2021_combined.openai_user_embeddings` emb
    ...
    embeddings_table_name = f"tweet-research-shared.election_2020_transition_2021_combined.openai_user_embeddings"
